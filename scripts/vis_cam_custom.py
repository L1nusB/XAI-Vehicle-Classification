...
class Arguments:
    def __init__(self, img, config, checkpoint, target_layers=[], preview_model=False, method='GradCAM', target_category=[], eigen_smooth=False, aug_smooth=False, device='cpu', vit_like=None, num_extra_tokens=None, cfg_options=None):
        self.img = img
        self.config = config
...
def getCAM_Manual(img, config, checkpoint, target_layers=[], preview_model=False, method='GradCAM', target_category=[], eigen_smooth=False, aug_smooth=False, device='cpu', vit_like=None, num_extra_tokens=None, cfg_options=None):
    args = Arguments(img, config, checkpoint, target_layers, preview_model, method, target_category, eigen_smooth, aug_smooth, device, vit_like, num_extra_tokens, cfg_options)
    return getCAM(args)
